...
export default function Affiliate(props) {
    ...
    return (
        <>
            <div >
                <div className="my-link Earned_USD bg-color p-0 br-1">
                <div className="  p-3 row">
                    <p className="p-color p_b">{props.data.text}</p>
                    {/* <h1 className="h-color h3">{props.data.earned_usd}</h1> */}
                    <div className='affilate affilate-block' >
                   ...
                   <div>
                    <CopyToClipboard text={props.data.earned_usd}
                        ...
                        <button className='default-btn affilate-btn' style={{ width: '7rem' }}>Copy</button>
